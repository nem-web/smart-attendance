...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)] p-4 text-[var(--text-body)]">
      <div className="max-w-5xl w-full bg-[var(--bg-card)] rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-[var(--border-color)]">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative">
          ...
          {step === 2 && (
            <button 
              onClick={() => setStep(1)}
              className="absolute top-8 left-8 text-[var(--text-body)] hover:text-[var(--text-main)] flex items-center gap-2 text-sm font-medium transition-colors"
            >
          ...
          <div className="w-full max-w-md mx-auto space-y-8">
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                >
                  <div className="w-12 h-12 bg-[var(--bg-secondary)] text-[var(--primary)] rounded-full flex items-center justify-center group-hover:bg-[var(--primary)] group-hover:text-[var(--text-on-primary)] transition-colors">
                    <GraduationCap size={24} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[var(--text-main)]">I am a Student</h3>
                    <p className="text-sm text-[var(--text-body)]">Track attendance & view analytics</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--text-body)]">Manage classes & reports</p>
                  </div>
                </button>
              </div>
            )}
               ...
               className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    />
                    <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-body)]" />
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <BookOpen
                          size={18}
                          className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-body)]"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:bg-[var(--bg-card)] transition-all pl-10 text-[var(--text-main)]"
                        />
                        <User
                          size={18}
                          className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-body)]"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:bg-[var(--bg-card)] transition-all pl-10"
                        />
                        <Hash size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-body)]" />
                      </div>
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:bg-[var(--bg-card)] transition-all pl-10"
                        />
                        <Phone size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-body)]" />
                      </div>
                    </div>
                  </>
                )}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <button 
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--text-body)] hover:text-[var(--text-main)] focus:outline-none"
                    >
        ...
        <div className="hidden md:block w-1/2 bg-[var(--bg-secondary)] relative overflow-hidden transition-colors duration-500">
          <div className="absolute top-0 right-0 w-full h-full opacity-10" style={{backgroundImage:"linear-gradient(to bottom right, var(--primary), var(--primary-hover))",}}></div>
          
          <div className="absolute inset-0 flex items-center justify-center p-12">
             <div className="text-center space-y-4 relative z-10">
               <div className="w-64 h-64 rounded-full mx-auto flex items-center justify-center shadow-lg mb-8 relative" style={{backgroundColor: "color-mix(in srgb, var(--bg-card) 30%, transparent)",border: "1px solid color-mix(in srgb, var(--border-color) 60%, transparent)",backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)",}}>
                  <div className="w-48 h-48 rounded-full opacity-20 blur-3xl absolute" style={{ backgroundColor: "var(--primary)" }}></div>
