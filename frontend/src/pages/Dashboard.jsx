      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button className="px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] text-[var(--text-main)] rounded-lg hover:bg-[var(--primary-hover)] hover:text-[var(--text-on-primary)] font-medium transition-colors flex items-center gap-2 cursor-pointer">
              <Download size={18} />
              Download report
            </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-[var(--bg-card)] rounded-2xl p-6 shadow-sm border border-[var(--border-color)] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <span className="px-3 py-1 bg-[var(--bg-secondary)] text-[var(--text-body)] rounded-full font-medium text-sm">Next class: Grade 10A • 09:00</span>
                  <span className="px-3 py-1 bg-[var(--bg-secondary)] text-[var(--text-body)] rounded-full font-medium text-sm">Room 203</span>
                </div>
              </div>

              <div className="flex flex-col items-end gap-3 w-full md:w-auto">
                <span className="text-xs font-medium text-[var(--primary)] bg-[var(--bg-secondary)] px-2 py-1 rounded">Face recognition is ready</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Stat 1 */}
              <div className="bg-[var(--stat-bg)] text-[var(--stat-text)] rounded-2xl p-5 relative overflow-hidden">
                <p className="text-[var(--stat-muted)] text-sm font-medium mb-1">Today's attendance rate</p>
                <div className="flex items-end justify-between">
                  <h3 className="text-3xl font-bold">94%</h3>
                  <span className="text-xs px-2 py-1 rounded" style={{ background: "color-mix(in srgb, var(--stat-text) 20%, transparent)" }}>+3% vs last week</span>
                </div>
              </div>

              {/* Stat 2 */}
              <div className="bg-[var(--stat-bg)] text-[var(--stat-text)] rounded-2xl p-5">
                <p className="text-[var(--stat-muted)] text-sm font-medium mb-1">Absent</p>
                <div className="flex items-end justify-between">
                  <h3 className="text-3xl font-bold">7</h3>
                  <span className="text-xs px-2 py-1 rounded" style={{ background: "color-mix(in srgb, var(--stat-text) 20%, transparent)" }}>Across all classes</span>
                </div>
              </div>

              {/* Stat 3 */}
              <div className="bg-[var(--stat-bg)] text-[var(--stat-text)] rounded-2xl p-5">
                <p className="text-[var(--stat-muted)] text-sm font-medium mb-1">Late arrivals</p>
                <div className="flex items-end justify-between">
                  <h3 className="text-3xl font-bold">3</h3>
                  <span className="text-xs px-2 py-1 rounded" style={{ background: "color-mix(in srgb, var(--stat-text) 20%, transparent)" }}>First period</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[var(--bg-card)] p-6 rounded-2xl shadow-sm border border-[var(--border-color)]">
              ...
              <div className="h-40 bg-[var(--bg-secondary)] rounded-xl w-full flex items-center justify-center text-[var(--text-body)] mb-4 border border-dashed border-[var(--border-color)]">
                Chart Area
              </div>

              <div className="flex justify-center gap-4 text-xs">
                <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-[var(--primary)]"></span> Present</div>
                <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-[var(--border-color)]"></span> Absent</div>
                <div className="flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-[var(--warning)]"></span> Late</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[var(--bg-card)] p-4 rounded-xl shadow-sm border border-[var(--border-color)] border-l-4 border-l-[var(--success)]">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="px-2 py-0.5 bg-[var(--success-bg)] text-[var(--success)] text-[10px] font-bold uppercase tracking-wide rounded-full">Completed</span>
                </div>
              ...
              {/* Card 2 */}
              <div className="bg-[var(--bg-card)] p-4 rounded-xl shadow-sm border border-[var(--border-color)] border-l-4 border-l-[var(--info)]">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-semibold text-[var(--text-main)]">Grade 9B Physics</h4>
                  <span className="px-2 py-0.5 bg-[var(--info-bg)] text-[var(--info)] text-[10px] font-bold uppercase tracking-wide rounded-full">Upcoming</span>
                </div>
                <div className="flex justify-between items-end">
                  <div className="text-xs text-[var(--text-body)] flex flex-col gap-1">
                  ...
                  <span className="text-xs font-medium text-[var(--info)]">Starts in 30 min</span>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-card)] p-4 rounded-xl shadow-sm border border-[var(--border-color)] border-l-4 border-l-[var(--warning)]">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="px-2 py-0.5 bg-[var(--warning-bg)] text-[var(--warning)] text-[10px] font-bold uppercase tracking-wide rounded-full">Pending</span>
                </div>
                <div className="flex justify-between items-end">
                  <div className="text-xs text-[var(--text-body)] flex flex-col gap-1">
